...
echo "[deprecated] use code/scripts/MoDES/run_modes_search_pruning_rate_by_mcqa.sh for a clearer name" >&2
...
"$PYTHON_BIN" -m moe_prune.code.scripts.MoDES.run_modes_search_pruning_rate \
